...
<div class="rvt-layout__sidebar [ rvt-p-top-xxl-md-up rvt-p-left-md rvt-bg-black-000 ]" id="section-nav">
  ...
  <ul class="rvt-sidenav__list">
    <li class="rvt-sidenav__item">
      <a href="https://cgi.luddy.indiana.edu/~team09/group.php" class="rvt-sidenav__link">About</a>
    </li>
    <li class="rvt-sidenav__item">
      <a href="https://cgi.luddy.indiana.edu/~team09/grouppostspage.php" class="rvt-sidenav__link" aria-current="page">Posts</a>
    </li>
    <li class="rvt-sidenav__item">
      <a href="#" class="rvt-sidenav__link">Members</a>
    </li>
  </ul>
    </nav>
</div>
            ...
            *************************************************************** -->
            ...
            <div class="rvt-flex-lg-up">
                ...
                *************************************************************** -->
                ...
                <div class="rvt-dialog" id="new-post" role="dialog" tabindex="-1" aria-labelledby="dialog-title" aria-describedby="dialog-description" data-rvt-dialog="post">
...
<textarea id="textarea-default" class="rvt-textarea"></textarea>
  ...
  <div class="rvt-dialog__controls">
    <a href="https://cgi.luddy.indiana.edu/~team09/grouppostspage.php">
