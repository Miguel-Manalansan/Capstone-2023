...
if(isset($_POST['search']) ){
    $sql = "Select * from groups WHERE groups.name LIKE '%" . $_POST['search'] . "%'";
} else {
...
<head>
  ...
  <title>Course Buddy - Groups</title>
...
<main id="main-content" class="rvt-layout__wrapper" id="main-content">
    ...
    *********************************************************************** -->
    ...
    <div class="rvt-bg-crimson rvt-p-tb-xl rvt-p-tb-xxl-md-up">
        <div class="rvt-container-sm rvt-prose rvt-flow rvt-text-center">
            <h1 class="rvt-color-white">Course Groups</h1>
                </div>
    </div>
    ...
    *********************************************************************** -->
    ...
    <div class="rvt-container-lg rvt-p-top-lg">
        <ul class="rvt-list-reset rvt-flex rvt-wrap rvt-justify-center rvt-p-bottom-lg rvt-border-bottom">
            <li class="rvt-m-right-xs">
                <a href="#0" class="rvt-badge rvt-badge--secondary">Study Groups</a>
            </li>
            <li class="rvt-m-right-xs">
                <a href="#0" class="rvt-badge rvt-badge--secondary">Sport Groups</a>
            </li>
            <li class="rvt-m-right-xs">
                <a href="#0" class="rvt-badge rvt-badge--secondary">Club Groups</a>
            </li>
            <li class="rvt-m-right-xs">
                <a href="#0" class="rvt-badge rvt-badge--secondary">Class Groups</a>
            </li>
        </ul>
    </div>
    ...
    *********************************************************************** -->
    ...
    <div class="rvt-container-lg rvt-p-tb-xl">
        ...
        <ul class="rvt-row rvt-row--loose">
            ...
            <?php include 'includes/groupcarasoul.php';?>
        </ul>
    <!-- **********************************************************************
        Pagination
    *********************************************************************** -->
