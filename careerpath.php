    ...
    <main id="main-content" class="rvt-layout__wrapper rvt-layout__wrapper--details rvt-container-lg">
        <li class="rvt-sidenav__item">
            <div class="rvt-sidenav__item-wrapper">
                <a href="#0" class="rvt-sidenav__link">
                </a>
        ...
        <li class="rvt-sidenav__item">
            <div class="rvt-sidenav__item-wrapper">
                ...
                <button class="rvt-sidenav__toggle" data-rvt-sidenav-toggle="toggle-4">
                    <span class="rvt-sr-only">Toggle section level two menu</span>
                    <svg width="16" height="16" viewBox="0 0 16 16">
                        <path fill="currentColor"
                            d="M8,12.46a2,2,0,0,1-1.52-.7L1.24,5.65a1,1,0,1,1,1.52-1.3L8,10.46l5.24-6.11a1,1,0,0,1,1.52,1.3L9.52,11.76A2,2,0,0,1,8,12.46Z" />
                    </svg>
    ...
    *********************************************************************** -->
        ...
        ******************************************************************* -->
            <div class="rvt-m-top-xxl rvt-m-top-md-md-up rvt-flow rvt-prose">
                <h1>Become the most professional version of yourself at IU</h1>
                <p class="rvt-ts-20 rvt-color-black-500">Develop the skills you need for a rewarding career, connect
                    with other professional and reach your goals with the help of IU's resources.</p>
            </div>
            ...
            *************************************************************** -->
                <div class="rvt-layout__feature-slot">
                    <div class="rvt-card rvt-card--raised">
                        <div class="rvt-card__body">
                            <span class="rvt-ts-18 rvt-text-bold">Reach For Your Future</span>
                            <p>IU offers many different career services. Need help? Click the link below for resources!
                            </p>
                            <a href="https://cdc.indiana.edu/" class="rvt-cta">ADD LINK TO CAREER SERVICES PAGE</a>
                        </div>
                    </div>
                </div>
                <!-- **************************************************************
                Running text
            *************************************************************** -->
                <p>Let Class Buddy help you by providing a resource page with any links that may be helfpul in
                    furthering your schooling and your career.</p>
                <h3>Plan your next semester and get a clear look at what's ahead.</h3>
                <a href="https://one.iu.edu/task/iu/igps-plan" class="rvt-cta">IU Degree Maps</a>
                <hr>
                <h3>Create a network that will boost your career</h3>
                <p>Use networking websites to make valuable connections with other professionals in your school as well
                    as recruiters for jobs after college.</p>
                <a href="https://www.linkedin.com/home" class="rvt-cta">LinkedIn</a>
                <a href="https://joinhandshake.com/" class="rvt-cta">Handshake</a>
                <!-- **************************************************************
                Breakout element
            *************************************************************** -->
                ...
                Running text
            *************************************************************** -->
                    <h2>Explore different professors before taking classes</h2>
                    <a href="https://www.ratemyprofessors.com/search/teachers?query=*&sid=440" class="rvt-cta">Rate my
                        Professors for IU Bloomington</a>
                    <hr>
                    </ul>
            </div>
        </div>
        ...
        <div class="rvt-container-lg">
            <div class="rvt-footer-base__inner">
                ...
                <ul class="rvt-footer-base__list">
                    ...
                    <li class="rvt-footer-base__item">
                        <a class="rvt-footer-base__link" href="#0">Copyright</a> © 2021 The Trustees of <a
                            class="rvt-footer-base__link" href="https://www.iu.edu">Indiana University</a>
                    </li>
                </ul>
            </div>
