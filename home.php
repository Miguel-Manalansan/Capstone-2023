...
<main id="main-content" class="rvt-layout__wrapper">
    <rvt-alert variant="<?php echo $alert_variant; ?>" role="alert">
        ...
        <div class="rvt-container-lg">
            <div class="rvt-hero__inner">
                <div class="rvt-hero__body [ rvt-flow ]">
                    ...
                    <h1 class="rvt-hero__title">Welcome to Class Buddy!</h1>
                    <div class="rvt-hero__teaser">
                        
                    </div>
                    <div class="rvt-hero__actions">
                        <a class="rvt-cta rvt-cta--button" href="https://cgi.luddy.indiana.edu/~team09/login.php">Login!</a>
                    </div>
                </div>
                <div class="rvt-hero__media">
                    <img src="iu_logo.jpg" alt="Person wearing a mortarboard and graduation gown against a crimson background">
                </div>
            </div>
        </div>
    </div>
